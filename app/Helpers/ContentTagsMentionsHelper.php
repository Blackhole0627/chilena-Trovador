...
class ContentTagsMentionsHelper
{
     ...
     * @return list<int>
     */
    public function syncForComment(PostComment $comment, bool $sendMentionNotifications = true): array
    {
        return $this->sync(
            ...
            sendMentionNotifications: $sendMentionNotifications,
        );
    }
