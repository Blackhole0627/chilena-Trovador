...
@section('content')
    ...
    @include('elements.messenger.empty-states')
                    ...
                    <section class="conversation-wrapper d-flex flex-column flex-fill border-right">
                        ...
                        <div class="conversation-writeup d-flex align-items-center {{!$lastContactID ? 'hidden' : ''}}">
                            ...
                            <div class="messenger-buttons-wrapper d-flex align-items-center">
                                <button class="btn btn-outline-primary btn-rounded-icon messenger-button attach-file file-upload-button mx-0 mx-md-1 to-tooltip" data-placement="top" title="{{__('Attach file')}}">
                                    <div class="d-flex justify-content-center align-items-center">
                                        @include('elements.icon',['icon'=>'document','variant'=>''])
                                    </div>
                                </button>
                                <button type="button" class="btn btn-outline-primary btn-rounded-icon messenger-button voice-record-toggle mx-0 mx-md-1 to-tooltip d-none" data-placement="top" title="{{__('Record audio')}}">
                                    <div class="d-flex justify-content-center align-items-center">
                                        @include('elements.icon',['icon'=>'mic-outline','variant'=>''])
                                    </div>
                                </button>
                            </div>
                            <div class="messenger-voice-recorder d-none align-items-center flex-fill">
                                <div class="messenger-voice-recording-dot"></div>
                                <span class="messenger-voice-recording-label">{{__('Recording')}}</span>
                                <canvas class="messenger-voice-waveform" height="28" aria-hidden="true"></canvas>
                                <span class="messenger-voice-recording-time">0:00</span>
                                <button type="button" class="btn btn-outline-secondary btn-rounded-icon messenger-button voice-record-cancel to-tooltip" data-placement="top" title="{{__('Cancel')}}">
                                    <div class="d-flex justify-content-center align-items-center">
                                        @include('elements.icon',['icon'=>'close-outline','variant'=>''])
                                    </div>
                                </button>
                                <button type="button" class="btn btn-outline-danger btn-rounded-icon messenger-button voice-record-stop to-tooltip" data-placement="top" title="{{__('Stop recording')}}">
                                    <div class="d-flex justify-content-center align-items-center">
                                        @include('elements.icon',['icon'=>'stop-outline','variant'=>''])
                                    </div>
                                </button>
                            </div>
                            {{-- Input --}}
