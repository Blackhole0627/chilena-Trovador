    ...
    <div class="flex gap-3 pr-4">
        <div class="d-flex v-align-center mb-1">
            ...
            <p class="font-semibold text-yellow-800 dark:text-yellow-300 ml-1 mb-0">
                Crypto.com Pay requires a <em>Webhook URL</em> and signature secret.
            </p>
        </div>
        ...
        <div class="space-y-2">
            <ul class="list-disc list-inside text-sm">
                <li>
                    <code>{{ route('cryptocom.payment.update') }}</code>
                </li>
            </ul>

            <p class="text-sm mb-0">
                Configure this URL in your Crypto.com Pay webhook settings, subscribe to <code>payment.captured</code> and <code>payment.cancelled</code>, and copy the matching signature secret into the field below.
            </p>
            <p class="text-sm mb-0">
                Learn more in the
                <a href="##cryptocom"
                   ...
                   target="_blank"
                >Crypto.com integration guide</a>.
            </p>
        </div>
    </div>
