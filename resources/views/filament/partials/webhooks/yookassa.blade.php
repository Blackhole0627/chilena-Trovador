    ...
    <div class="flex gap-3 pr-4">
        <div class="d-flex v-align-center mb-1">
            ...
            <p class="font-semibold text-yellow-800 dark:text-yellow-300 ml-1 mb-0">
                YooMoney requires a <em>Webhook URL</em>.
            </p>
        </div>
        ...
        <div class="space-y-2">
            <ul class="list-disc list-inside text-sm">
                <li>
                    <code>{{ route('yookassa.payment.update') }}</code>
                </li>
            </ul>

            <p class="text-sm mb-0">
                Configure this notification URL in your YooMoney dashboard to keep transaction statuses in sync.
            </p>
            <p class="text-sm mb-0">
                Learn more in the
                <a href="##yookassa"
