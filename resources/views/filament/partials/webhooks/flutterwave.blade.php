    ...
    <div class="flex gap-3 pr-4">
        <div class="d-flex v-align-center mb-1">
            ...
            <p class="font-semibold text-yellow-800 dark:text-yellow-300 ml-1 mb-0">
                Flutterwave requires a webhook URL and secret hash.
            </p>
        </div>
        ...
        <div class="space-y-2">
            <ul class="list-disc list-inside text-sm">
                <li>
                    <code>{{ route('flutterwave.payment.update') }}</code>
                </li>
            </ul>

            <p class="text-sm mb-0">
                Set this URL in your Flutterwave dashboard webhook settings and use the same secret hash in both Flutterwave and the field below.
            </p>
            <p class="text-sm mb-0">
                Learn more in the
                <a href="##flutterwave"
                   ...
                   target="_blank"
                >Flutterwave integration guide</a>.
            </p>
        </div>
    </div>
