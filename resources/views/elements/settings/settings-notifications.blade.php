...
<div class="card mb-3">
    <div class="card-body">
        <h6 class="mb-0">{{ __('Email notifications') }}</h6>
        <div class="mt-1 mb-3">
            <span class="text-sm text-muted">{{ __('Choose which events can send you an email.') }}</span>
        </div>
        <form>
            ...
            <div class="form-group">
                <div class="custom-control custom-switch">
                    ...
                    <label class="custom-control-label" for="notification_email_new_comment">{{__('New comments and replies')}}</label>
                </div>
            </div>
